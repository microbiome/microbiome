...
p <- plot_landscape(pseq.core, "PCA", transformation = "clr")
print(p)
```
...
p <- plot_landscape(abundances(transform(pseq.core, "log10"))[, 1:2], method = "PCoA")
print(p)
```
...
p <- plot_landscape(pseq, "t-SNE", distance = "bray", transformation = "compositional")
print(p)
```
