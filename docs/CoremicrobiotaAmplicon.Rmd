...
```{r, read-simple-csv-otu-tables, warning=FALSE, message=FALSE}
library(microbiome)
...
```{r, core-microbiota-amplicon-data}
...
```{r,core-example4, fig.width=14, fig.heigth=18, fig.show='hold', out.width = '200px', warning=FALSE}
