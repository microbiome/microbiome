...
including dplyr `r citep(citation("dplyr"))`, ggplot2 `r citep(citation("ggplot2"))`, phyloseq `r citep(citation("phyloseq"))`, stats `r citep(citation("stats"))`, tidyr `r citep(citation("tidyr"))`, vegan `r citep(citation("vegan"))`.
