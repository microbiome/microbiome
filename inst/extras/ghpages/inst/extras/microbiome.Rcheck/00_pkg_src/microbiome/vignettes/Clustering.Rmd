...
```{r LCA2, fig.width=6, fig.height=5, warning=FALSE, message=FALSE}
library(netresponse)
...
```{r LCA1, fig.width=7, fig.height=5, warning=FALSE, message=FALSE}
...
```{r clustering-gower, fig.width=10, fig.height=4, warning=FALSE, message=FALSE}
# Example data
data("dietswap")
