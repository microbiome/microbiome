...
~/bin/R-4.0.0/bin/R CMD check microbiome_2.1.22.tar.gz #--no-build-vignettes --no-examples
~/bin/R-4.0.0/bin/R CMD BiocCheck microbiome_2.1.22.tar.gz
~/bin/R-4.0.0/bin/R CMD INSTALL microbiome_2.1.22.tar.gz 
