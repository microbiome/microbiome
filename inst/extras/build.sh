...
~/bin/R-4.0.0/bin/R CMD check microbiome_1.11.2.tar.gz #--no-build-vignettes --no-examples
~/bin/R-4.0.0/bin/R CMD BiocCheck microbiome_1.11.2.tar.gz
~/bin/R-4.0.0/bin/R CMD INSTALL microbiome_1.11.2.tar.gz 
