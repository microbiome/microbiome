...
~/bin/R-patched/bin/R CMD check microbiome_2.1.1.tar.gz #--no-build-vignettes --no-examples
~/bin/R-patched/bin/R CMD BiocCheck microbiome_2.1.1.tar.gz
~/bin/R-patched/bin/R CMD INSTALL microbiome_2.1.1.tar.gz 
