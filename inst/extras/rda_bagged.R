...
#'   res <- rda_bagged(x, y, sig.thresh=0.05, nboot=20)
#'   plot_rda_bagged(res, y)
#'
#'   # Example with phyloseq object
#'   res <- rda_bagged(phy, "gender", sig.thresh=0.05, nboot=20)
#'   plot_rda_bagged(res, y)
#'
#'  }
#' @aliases bagged_rda
...
#' @keywords utilities
rda_bagged <- function(x, y, sig.thresh = 0.1, nboot = 1000, verbose = T){
