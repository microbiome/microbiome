...
To import microbiome profiling data from standard formats (mothur,
qiime etc.) into R, use the 
[phyloseq](http://joey711.github.io/phyloseq/import-data) R package.

For examples on data processing (filtering, subsetting etc.), see the [preprocessing tutorial](Preprocessing.md).
