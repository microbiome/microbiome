...
```{r landscape3, message=FALSE, warning=FALSE, fig.width=11, fig.height=6, fig.show="hold", out.width="400px"}
...
```{r landscape4, message=FALSE, warning=FALSE, fig.width=11, fig.height=6, fig.show="hold", out.width="400px"}
