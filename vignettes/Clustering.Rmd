...
```{r LCA2, fig.width=8, fig.height=8, warning=FALSE, message=FALSE, fig.path = "figure/"}
library(netresponse)
...
```{r LCA1, fig.width=8, fig.height=8, warning=FALSE, message=FALSE, fig.path = "figure/"}
library(netresponse)
...
```{r clustering-example, message=FALSE, warning=FALSE, fig.width=8, fig.heigth=8, fig.path = "figure/"}
