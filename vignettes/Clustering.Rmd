...
```{r LCA2, fig.width=6, fig.height=5, warning=FALSE, message=FALSE, fig.path = "figure/"}
library(netresponse)
...
```{r LCA1, fig.width=7, fig.height=5, warning=FALSE, message=FALSE, fig.path = "figure/"}
