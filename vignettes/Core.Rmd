...
```{r core-prevalence, fig.path = "figure/"}
# Load example data
library(microbiome)
data("peerj32")
...
```{r core-prevalence2, fig.path = "figure/"}
...
```{r core-example3, fig.width=8, fig.heigth=15, fig.path = "figure/", fig.show='hold', out.width = '430px'}
