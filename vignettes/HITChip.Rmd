...
## HITChip and other phylogenetic microarrays
  ...
  * [Extracting data from HITChip database](https://github.com/microbiome/HITChipDB/blob/master/index./index.md)
...
```{r HITChipDBinstalltest, message=FALSE, warning=FALSE, eval=TRUE}
library(microbiome)
```
