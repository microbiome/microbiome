...
You can modify one of the existing examples (Rmd) and make a pull request. Or, you can propose a new tutorial page. The Rmarkdown source code (.Rmd) for all [tutorials](http://microbiome.github.io/microbiome/) is available in the Github [index.page](https://github.com/microbiome/microbiome/tree/master/index.). Fork the repository, clone it, modify the tutorials, and make a pull request.
