...
You can modify one of the existing examples (Rmd) and make a pull request. Or, you can propose a new tutorial page. The Rmarkdown source code (.Rmd) for all [tutorials](http://microbiome.github.io/microbiome/) is available in the Github [vignette page](https://github.com/microbiome/microbiome/tree/master/vignettes). Fork the repository, clone it, modify the tutorials, and make a pull request.
