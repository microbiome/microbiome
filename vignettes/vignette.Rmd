...
```{r composition-example4b, fig.width=12, fig.height=5, out.width="300px", fig.show="hold", fig.cap = "Figure caption goes here.", warning=FALSE, message=FALSE}
# Try another theme
...
The main developer is [Leo Lahti](https://github.com/antagomir/).
