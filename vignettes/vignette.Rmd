 ...
 * MASS `r citep(citation("MASS"))`
 * moments `r citep(citation("moments"))`
 * netresponse `r citep(citation("netresponse"))` 
 * phyloseq `r citep(citation("phyloseq"))`
 * RColorBrewer `r citep(citation("RColorBrewer"))`
 * scales `r citep(citation("scales"))`
 * stats `r citep(citation("stats"))`
