...
The microbiome package contains general-purpose tools for microarray-based analysis of microbiome profiling data sets in R `r citep(bib[["rcore13"]])`. See also the related but independent R package [phyloseq](https://github.com/joey711/phyloseq).
