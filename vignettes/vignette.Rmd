...
To ease that transition, most functions in this package also accept a
`TreeSummarizedExperiment` in place of a `phyloseq` object. See
`vignette("treesummarizedexperiment", package="microbiome")` for a
walkthrough of the standard operations on that container.
