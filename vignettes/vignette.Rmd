...
The microbiome package provides tools for microbiome analytics and
visualization in R `r citep(bib[["rcore13"]])`. 


### Getting started

* [Installation instructions](Template.md) 
* [Example data sets](Data.md)
* [Data filtering and manipulation](Preprocessing.md)
...
* [PCA, PCoA and other ordination techniques](Ordination.md)
* [RDA](RDA.md)
