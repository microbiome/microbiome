...
Microbiome analytics for R `r citep(bib[["rcore13"]])`.

The microbiome package utilizes the [phyloseq data
format](https://github.com/joey711/phyloseq), adding extra
functionality for microbiome analytics and visualization. See
[installation instructions](Template.md) to get started.

### Data


* [Downloading example data](Data.md)
