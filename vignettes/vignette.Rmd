...
related [PathoStat
pipeline](http://bioconductor.org/packages/release/bioc/vignettes/PathoStat/inst/doc/PathoStatIntro.html)
...
```{r microbiomeinstall, eval=FALSE}
...
```{r reg, fig.width=10, fig.height=5, dev="CairoPNG"}
...
```{r beta, fig.width=5, fig.height=5, out.width="300px"}
...
```{r hm3, fig.width=12, fig.height=9, out.width="400px"}
...
```{r varpl2, fig.show='hold', out.width="430px"}
