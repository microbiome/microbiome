...
`r sessionInfo()$otherPkgs$microbiome$Version`. URL:
...
```{r reg, message=FALSE, fig.width=10, fig.height=5, warning=FALSE, dev="CairoPNG"}
...
```{r beta, message=FALSE, fig.width=5, fig.height=5, warning=FALSE, out.width="300px"}
...
```{r corevisu, fig.width=8, fig.heigth=20, out.width = '350px'}
...
```{r compheat, message=FALSE, warning=FALSE, fig.height=8, fig.width=12, out.width="300px"}
...
```{r compbar, message=FALSE, warning=FALSE, fig.height=6, fig.width=12}
...
```{r hm3, fig.width=12, fig.height=9, message=FALSE, warning=FALSE, out.width="400px"}
...
```{r varpl2, message=FALSE, warning=FALSE, fig.show='hold', out.width="430px"}
