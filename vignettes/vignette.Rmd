...
```{r beta, message=FALSE, fig.width=10, fig.height=5, warning=FALSE}
...
```{r compheat, message=FALSE, warning=FALSE, fig.height=8, fig.width=12}
...
```{r compbar, message=FALSE, warning=FALSE, fig.height=8, fig.width=12}
...
```{r hm3, fig.width=12, fig.height=8, message=FALSE, warning=FALSE}
