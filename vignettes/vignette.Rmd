...
This tutorial provides a brief overview on the package functionality with example data sets from published studies `r citep(bib[c("lahti14natcomm", "Lahti13provasI", "OKeefe15")])`.
