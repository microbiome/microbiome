...
```{r rda, warning=FALSE, message=FALSE}
...
```{r rda2, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
library(vegan)
...
```{r rda3, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
