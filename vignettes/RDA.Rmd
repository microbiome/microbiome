...
```{r rda, warning=FALSE, message=FALSE, fig.path = "figure/", eval = FALSE}
library(microbiome)
...
```{r rda4, warning=FALSE, message=FALSE, fig.width=8, fig.height=8, fig.path = "figure/", eval = FALSE}
library(phyloseq)
...
```{r rda3, warning=FALSE, message=FALSE, fig.width=8, fig.height=8, fig.path = "figure/", eval = FALSE}
