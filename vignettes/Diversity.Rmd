...
```{r diversitywithmetadata, warning=FALSE, message=FALSE, fig.width=16, fig.heigth=8, fig.path = "figure/"}
par(mar = c(6, 4, 3, 1))
...
```{r visu-example3, fig.width=8, fig.height=8, message=FALSE, warning=FALSE, fig.path = "figure/"}
library(microbiome)
library(sorvi)
library(dplyr)
