...
```{r div-example2, warning=FALSE, message=FALSE, fig.path = "figure/", fig.width=8, fig.heigth=5}
...
```{r div-example2b, warning=FALSE, message=FALSE, fig.path = "figure/", fig.width=8, fig.heigth=5}
...
```{r diversitywithmetadata2, warning=FALSE, message=FALSE, fig.width=8, fig.heigth=5, fig.path = "figure/"}
...
```{r diversitywithmetadata2b, warning=FALSE, message=FALSE, fig.width=8, fig.heigth=5, fig.path = "figure/"}
