...
```{r composition-example1b, fig.width=15, fig.height=5, message=FALSE}
# Pick sample subset
library(phyloseq)
...
```{r composition-example5, fig.width=8, fig.height=3}
...
```{r composition-example6, fig.width=9, fig.height=3}
...
```{r composition-example8, fig.width=9, fig.height=3, warning=FALSE}
