...
```{r composition-example5, fig.path = "figure/", fig.width=8, fig.height=4}
...
```{r composition-example6, fig.path = "figure/", fig.width=8, fig.height=4}
...
```{r composition-example7, fig.path = "figure/", fig.width=8, fig.height=4}
res <- plot_composition(pseq3, plot.type = "heatmap", transformation = "Z-OTU",
...
```{r composition-example8, fig.path = "figure/", fig.width=8, fig.height=4, warning=FALSE}
