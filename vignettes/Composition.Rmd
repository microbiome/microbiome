...
```{r composition-example1b, fig.width=18, fig.height=5, message=FALSE}
# Pick sample subset
library(phyloseq)
...
```{r composition-example5, fig.width=12, fig.height=3}
...
```{r composition-example6, fig.width=12, fig.height=3}
...
```{r composition-example7, fig.width=12, fig.height=3}
res <- plot_composition(pseq3, plot.type = "heatmap", transformation = "Z-OTU",
...
```{r composition-example8, fig.width=12, fig.height=3, warning=FALSE}
