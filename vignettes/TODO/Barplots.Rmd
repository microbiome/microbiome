...
```{r barplot-example, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
...
```{r barplot-example2, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
# Load Phylogeny
phylogeny.info <- GetPhylogeny("HITChip")
...
l2 <- droplevels(levelmap(taxa, level.from = "taxa", level.to = "L2", phylogeny.info = phylogeny.info)$L2)
l1 <- droplevels(levelmap(taxa, level.from = "taxa", level.to = "L1", phylogeny.info = phylogeny.info)$L1)
