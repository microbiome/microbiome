...
```{r ordination4, message=FALSE, warning=FALSE, fig.width=7, fig.height=5}
# Highlighting gender
...
```{r ordination-visu-example2, message=FALSE, message=FALSE, fig.height=7, fig.width=5}
ax1 <- names(proj)[[1]]
ax2 <- names(proj)[[2]]
...
```{r ordination-pca-ordination21, message=FALSE, message=FALSE, fig.height=6, fig.width=12}
...
```{r ordination-pca-ordination22, message=FALSE, message=FALSE, fig.height=10, fig.width=13}
...
```{r ordination-ordinate23, warning=FALSE, message=FALSE, fig.width=10, fig.height=7}
...
```{r ordination-ordinate24a, warning=FALSE, message=FALSE, fig.width=9, fig.height=5}
...
```{r ordination-ordinate24b, warning=FALSE, message=FALSE, fig.width=10, fig.height=5}
...
```{r ordination-ordinate25, warning=FALSE, message=FALSE, fig.width=10, fig.height=5}
...
```{r ordination-ordinate26, warning=FALSE, message=FALSE, fig.width=10, fig.height=5}
