...
```{r ordination2, message=FALSE, warning=FALSE, fig.path = "figure/", message=FALSE}
set.seed(423542)
library(phyloseq)
...
```{r pca-ordination21, message=FALSE, message=FALSE, fig.height=8, fig.width=15}
...
```{r pca-ordination22, message=FALSE, message=FALSE, fig.height=8, fig.width=15}
