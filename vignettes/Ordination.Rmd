...
```{r ordination4, message=FALSE, warning=FALSE, fig.width=7, fig.height=5, fig.show="hold", out.width="400px"}
# Highlighting gender
...
```{r ordination-ordinate24a, warning=FALSE, message=FALSE, fig.width=12, fig.height=6, fig.show="hold", out.width="400px"}
# With samples
