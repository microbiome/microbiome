...
```{r ordination-visu-example2, message=FALSE, message=FALSE, fig.height=6, fig.width=7}
ax1 <- names(proj)[[1]]
ax2 <- names(proj)[[2]]
...
```{r ordination-pca-ordination21, message=FALSE, message=FALSE, fig.height=6, fig.width=10}
...
```{r ordination-ordinate24a, warning=FALSE, message=FALSE, fig.width=7, fig.height=6}
...
```{r ordination-ordinate24b, warning=FALSE, message=FALSE, fig.width=12, fig.height=6}
...
```{r ordination-ordinate25, warning=FALSE, message=FALSE, fig.width=12, fig.height=6}
...
```{r ordination-ordinate26, warning=FALSE, message=FALSE, fig.width=12, fig.height=5}
