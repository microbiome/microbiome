...
```{r ordination-pca-ordination21, message=FALSE, message=FALSE, fig.height=6, fig.width=8}
...
```{r ordination-pca-ordination22, message=FALSE, message=FALSE, fig.height=10, fig.width=10}
...
```{r ordination-ordinate24a, warning=FALSE, message=FALSE, fig.width=6, fig.height=6, fig.show="hold", out.width="400px"}
# With samples
