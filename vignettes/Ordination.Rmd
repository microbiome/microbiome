...
```{r ordination4, message=FALSE, warning=FALSE, fig.width=15, fig.height=8, fig.path = "figure/"}
# Highlight gender
...
```{r ordination3, message=FALSE, warning=FALSE, fig.width=15, fig.height=8, fig.path = "figure/"}
