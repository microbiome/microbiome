...
```{r composition-example4b, fig.width=6, fig.height=4, out.width="400px", fig.show="hold", warning=FALSE, message=FALSE}
# Try another theme
...
p <- plot_composition(transform(pseq, "compositional"),
	                plot.type = "heatmap",
                        sample.sort = "neatmap",
			otu.sort = "neatmap")
print(p)
...
```{r plot_prev, fig.height=6, fig.width=8, dev="CairoPNG", out.width="800px"}
data(atlas1006)
...
```{r plot_prev1, fig.height=6, fig.width=8}
# Use sample and taxa subset to speed up example
p0 <- subset_samples(ps1, DiseaseState == "H")
