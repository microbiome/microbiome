...
```{r composition-example4b, fig.width=10, fig.height=8, out.width="400px", fig.show="hold", warning=FALSE, message=FALSE}
# Try another theme
...
```{r composition-amplicon-example5, fig.width=12, fig.height=5, out.width="400px", fig.show="hold", warning=FALSE, message=FALSE}
# Averaged by group
