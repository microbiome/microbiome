...
```{r composition-example4b, fig.width=10, fig.height=8, out.width="50%", fig.show="hold", warning=FALSE, message=FALSE}
# Try another theme
...
```{r composition-example4c, fig.width=10, fig.height=8, out.width="80%", fig.show="hold", warning=FALSE, message=FALSE}
# Averaged by group
p <- plot_composition(pseq2,
