...
**Kindly cite this work** as follows: "Leo Lahti [et al.](https://github.com/microbiome/microbiome/graphs/contributors) (2017). microbiome: Tools for microbiome analysis. R package version `r sessionInfo()$otherPkgs$microbiome$Version`. URL: [http://ropengov.github.io/eurostat](http://microbiome.github.com/microbiome), or citing the references below when appropriate. The list of publications is not exhaustive. Let us know if you know of further publications using the microbiome package; we are collecting these on the website.
