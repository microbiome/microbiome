...
- Compare the results between rstanarm and standard alternatives (lm vs. stan_lm; aov vs. stan_aov) etc.
...
- Try out alternative formulations of the [linear model](http://mc-stan.org/rstanarm/articles/lm.html) (stan_lm and stan_glm)
