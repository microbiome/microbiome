...
This returns a table with selected diversity indicators. Check a separate page on [Diversities](Diversity.html) for other functions.
...
## Prepapre data for vizualisation
...
```{r Ad-plot5, warning=FALSE, message=FALSE, fig.width=8, fig.height=6}
...
```{r Ad-plot6, warning=FALSE, message=FALSE}
