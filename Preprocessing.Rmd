---
title: "Microbiome data manipulation"
...
# Remove pseudocount that exists in the example data
data(atlas1006)
x <- abundances(atlas1006) - 1 
# Compositional data without pseudocount
x2 <- transform(x, "compositional")
# KMSS replacement for zero-inflated compositional values
x3 <- multKM(x2, label = 0, dl = rep(0, ncol(x)), n.draws = 10, n.knots = NULL)
# CLR transformation for the augmented compositional data
x4 <- transform(x3, "clr")
```
