...
```{r univariate_boxplot, warning=FALSE, message=FALSE, fig.width=10, fig.height=5}
...
```{r univariate5, warning=FALSE, message=FALSE, fig.width=10, fig.height=5}
...
```{r univariate6, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
...
print(kable(summary(res)$coefficients))
```

There are also other ways to print the output nicely

```{r lm_coefs2, warning=FALSE, message=FALSE, results="asis"}
...
An important advantag of linear models, compared to plain t-test is
...
Huge tail of rare taxa (median abundance per taxa is shown):

```{r tail, warning=FALSE, message=print, fig.width=8, fig.height=8}
