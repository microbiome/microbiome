...
The intercept equals to the mean in the first group. The group term
equals to the difference between group means.
...
# Advanced models of differential abundance for sequencing data
