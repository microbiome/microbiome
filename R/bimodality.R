...
#'     \item{results}{Full results of potential_bootstrap for each row of the input matrix.}
#'   }
#' @details
#'   \itemize{
...
#'   }
#' @seealso coefficient_of_bimodality, dip.test
#' @references
#' \itemize{
...
#'     \item{results}{Full results of potential_bootstrap for each
