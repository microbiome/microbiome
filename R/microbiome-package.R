...
#'
#' @author Leo Lahti and Jarkko Salojarvi (University of Helsinki, Finland and Wageningen University, The Netherlands). \email{microbiome-admin@@googlegroups.com}
#' @references
