...
#' @description Quantify microbiota heterogeneity within a given sample set.
#' @details
#'
#' Microbiota heterogeneity within a given sample set can be quantified
#' by the average sample dissimilarity or beta diversity. Taking average over
...
#' @keywords utilities
group_diversity <- function(x, method = "anticorrelation") {
