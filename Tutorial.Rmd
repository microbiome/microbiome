...
This tutorial gets You started with the microbiome R tools. The aims are as follows:

 * Familiarize with the available R tools for microbial ecology

 * Understand possibilities and challenges with population-level
