...
This tutorial gets You started with R tools for microbial ecologym, in particular to get an introduction to

 * R tools for microbial ecology
 * Significance of custom data formats and tools
 * Reproducible document generation 
 * Possibilities and challenges with population-level microbiome profiling studies
